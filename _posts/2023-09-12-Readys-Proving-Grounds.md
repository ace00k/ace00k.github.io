...
After waiting for three minutes the script is executed, granting **SUID** permissions to `/bin/bash`. To spawn a root shell, type `bash -p` to spawn a shell in a privileged context.
